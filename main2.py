...
# Função para a aplicação de previsão de entrega
...
# Função para a aplicação do chatbot
def chatbot():
...
# Carregar dados da planilha Excel para a aplicação do chatbot
df = pd.read_excel('bdpi.xlsx')  # Ajuste o caminho do arquivo conforme necessário
